...
class AplicativoProcessadorArquivos:
    ...
    def normalizar_nome(self, nome):
        """Normaliza os caracteres especiais nos nomes dos funcionários"""
        substituicoes = {
            "Á": "A", "À": "A", "Â": "A", "Ã": "A",
            "É": "E", "Ê": "E", "È": "E",
            "Í": "I", "Ì": "I",
            "Ó": "O", "Ò": "O", "Ô": "O", "Õ": "O",
            "Ú": "U", "Ù": "U", "Ü": "U",
            "Ç": "C",  # Tratamento especial para o Ç
            "Ñ": "N",
            "Ý": "Y"
        }
    ...
    def extrair_dados_funcionarios(self, bloco, data_pagamento):
        ...
        if match_data:
            ...
            for cod, nome_func, salario in zip(codigos_func, nomes_func, salarios):
                nome_normalizado = self.normalizar_nome(nome_func)
                funcionarios.append({
                    ...
                    "ano_referencia": ano,
                    "cod_funcionario": cod,
                    "nome_funcionario": nome_normalizado,
